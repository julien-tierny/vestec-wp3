...
CinemaReader = simple.TTKCinemaReader(DatabasePath="../precomputed_diagrams/disease/pdiags.cdb")
...
Cluster.Numberofclusters = 5
Cluster.Maximalcomputationtimes = 10.0
Cluster.Displayingmethod = 'Clusters as stars' 
Cluster.Spacing = 1.05

simple.SaveData("./disease_clustered_diagrams.vtu", proxy=simple.OutputPort(Cluster,0))
simple.SaveData("./disease_centroids.vtu", proxy=simple.OutputPort(Cluster,1))
