...
class EMfields3D                // :public Field
{
  public:
    ...
    void initGEMnoPert();
    /* Uniform E,B, n for a test shock problem */
    void initShock();
    ...
    void initTaylorGreen(int tg_case, int & restarting_from_cycle);
    /// Initialise multiple nulls according to Politano's PoP 1995 paper
    void initPolitano(int pcase);
    /// Expand the Taylor-Green fields read from restart
    void expandTaylorGreenField(arr3_double arr, arr3_double field);
    /// Expand the Taylor-Green moments read from restart
    void expandTaylorGreenMoment(arr3_double arr, arr4_double field, int is);
